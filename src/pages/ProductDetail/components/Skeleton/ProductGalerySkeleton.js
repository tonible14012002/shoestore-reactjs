const ProductGalerySkeleton = () => {
    ...
    <div className="laptop:w-[90%] ">
        <div className="w-[100%]">
            <div className="pb-[100%] rounded-2xl bg-neutral-300 animate-pulse"></div>
                ...
                <div className="w-[100%] laptop:w-[90%]">
                    ...
                    >
                        {new Array(4).fill(null).map((image, index) => {
                            return (
                                <div className="bg-neutral-300 pb-[100%] ml-1 mr-1 rounded-xl overflow-hidden hover:cursor-pointer"
                                    key={index}
                                >
                                </div>
                            )   
